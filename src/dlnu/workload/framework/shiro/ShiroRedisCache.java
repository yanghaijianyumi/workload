package dlnu.workload.framework.shiro;
...
import dlnu.workload.framework.shiro.cached.ICached;
import dlnu.workload.framework.util.SerializeUtil;

public class ShiroRedisCache<K, V> implements Cache<K, V> {

	public Logger logger = LoggerFactory.getLogger(ShiroRedisCache.class);
