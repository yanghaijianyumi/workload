...
public class UserCourseAccountExcelView extends AbstractExcelView {
	...
	protected void buildExcelDocument(Map<String, Object> model,
		...
		c_t_name_0.setCellValue("申报教师名称:");
		c_t_name_0.setCellStyle(titleStyle);
		Cell c_t_name_1 = titleRow.createCell(1);
		c_t_name_1.setCellValue(user.getName());
		c_t_name_1.setCellStyle(titleStyle);

		Cell c_t_title_2 = titleRow.createCell(2);
		c_t_title_2.setCellValue("职称:");
		c_t_title_2.setCellStyle(titleStyle);
		CellRangeAddress c_t_titleCra = new CellRangeAddress(index - 1,
				index - 1, 3, 4);// 合并
		sheet.addMergedRegion(c_t_titleCra);
		Cell c_t_title_3 = titleRow.createCell(3);
		c_t_title_3.setCellValue(user.getTeacherTitle().getName());
		c_t_title_3.setCellStyle(titleStyle);

		Cell c_t_title_5 = titleRow.createCell(5);
		...
		Cell c_t_title_6 = titleRow.createCell(6);
		...
		Cell _c_h_courseName = _headerRow.createCell(0);
		...
		Cell _c_h_student = _headerRow.createCell(1);
		...
		Cell _c_h_courseNum = _headerRow.createCell(2);
		...
		Cell _c_h_classHour = _headerRow.createCell(5);
		...
		Cell _c_h_workload = _headerRow.createCell(6);
		...
		Cell _c_h_campus = _headerRow.createCell(9);
