			...
			.each(
					...
					function(index, semester) {
						var html = '<tr data-id="'
								...
								+ '<td><a class="btn btn-info glyphicon glyphicon-download-alt" href="/user/1234567890/major/cdesignAccounts/excel?type=previous&semester='
								+ semester.id + '"></a></td>' + '</tr>';
	...
	$('#semester-content td .glyphicon-eye-open').on(
			...
			function() {
				...
				var target = new CdesignAccountTargetObject(
						...
						'/api/user/1234567890/major/cdesignAccounts');
				...
				.each(
						...
						function(index, account) {
							...
							var html = '<tr data-id="'
									...
									// glyphicon-eye-open" aria-hidden="true"
									// data-toggle="modal"
									// data-target="#cdesignAccountModal"></span></td>'
									+ '</tr>';
