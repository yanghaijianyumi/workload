			...
			.each(
					...
					function(index, semester) {
						var html = '<tr data-id="'
								...
								+ '<td><a class="btn btn-info glyphicon glyphicon-download-alt" href="/user/1234567890/projectAccounts/excel?type=previous&semester='
								+ semester.id + '"></a></td>' + '</tr>';
	...
	$('#semester-content td .glyphicon-eye-open').on(
			...
			function() {
				...
				var target = new ProjectAccountTargetObject('#projectAct-page',
						'#projectAct-content',
						'/api/user/1234567890/projectAccounts');
