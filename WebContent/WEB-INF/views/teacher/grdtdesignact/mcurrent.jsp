...
<body>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<a class="btn btn-info" aria-hidden="true" data-toggle="modal"
								data-target="#userModal">增加教师</a> <a class="btn btn-info">工作量平分</a>
							<a class="btn btn-info" id="btn-save-grdtTeachers">保存设置</a>
						</div>
						...
						<table class="table table-bordered table-hover">
							...
							<!-- <td>1</td>
									<td>2011082222</td>
									<td>张三</td>
									<td><a href="#" id="test" data-type="text"
										data-placement="right" data-placeholder="Required"
										data-title="工作量">0</a></td>
									<td><a href="#" data-type="text" data-placement="right"
										data-placeholder="Required" data-title="计划学时">0</a></td>
									<td><a href="#" data-type="text" data-placement="right"
										data-placeholder="Required" data-title="备注"></a></td>
	...
	<script src="/js/tcugrdtdesignact.js"></script>
</body>
</html>